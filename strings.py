...
class ENG:
    ...
    INVFORM_TYPE_BUY_BUTTON = "BUY"
    INVFORM_TYPE_DIVIDEND = "Dividend"
    INVFORM_TYPE_DIVIDEND_BUTTON = "DIV"
    INVFORM_TYPE_SELL = "Sell"
    INVFORM_TYPE_SELL_BUTTON = "SEL"

    INVFORM_LAST_INVESTMENTS_DATE = "Date"
    INVFORM_LAST_INVESTMENTS_CASHFLOW = "Cashflow"
    INVFORM_LAST_INVESTMENTS_ASSET = "Asset"

    INVFORM_LABEL_EDIT_INVESTMENT = "Edit investment"
    INVFORM_BUTTON_EDIT_INVESTMENT_SUBMIT = "Save changes"
    INVFORM_BUTTON_EDIT_INVESTMENT_DELETE = "Delete investment"
    INVFORM_BUTTON_EDIT_INVESTMENT_CANCEL = "Cancel"
